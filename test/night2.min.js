      ...
      !(function () {
        ...
        var b = {
            getPosition: function (t, e, n) {
              var o = u * -n,
                ...
                a = S(r),
                s = v(r, o) - a.ra;
              return { azimuth: h(s, i, a.dec), altitude: y(s, i, a.dec) };
            }
          },
          k = (b.times = [
        ...
        (b.getTimes = function (t, n, o) {
          var i,
            ...
            D = g(b, 0),
            P = M(v, S, b),
            C = { solarNoon: l(P), nadir: l(P - 0.5) };
          for (i = 0, r = k.length; i < r; i += 1)
            (f = P - ((s = O((a = k[i])[0] * u, d, h, D, y, S, b)) - P)), (C[a[1]] = l(f)), (C[a[2]] = l(s));
          return C;
        }),
          ...
          (b.getMoonTimes = function (t, e, n, o) {
            ...
            for (
              var r,
                ...
                w = 1;
              w <= 24 &&
              ((r = b.getMoonPosition(P(i, w), e, n).altitude - S),
              (g =
                ((c = (k + (a = b.getMoonPosition(P(i, w + 1), e, n).altitude - S)) / 2 - r) *
                  (d = -(f = (a - k) / 2) / (2 * c)) +
                  f) *
                  d +
                r),
              (y = 0),
              (h = f * f - 4 * c * r) >= 0 &&
                ((v = d - (m = Math.sqrt(h) / (2 * Math.abs(c)))),
                (p = d + m),
                Math.abs(v) <= 1 && y++,
                Math.abs(p) <= 1 && y++,
                v < -1 && (v = p)),
